...
const ContactHeroBg = () => (
  <div className="absolute inset-0 overflow-hidden">
    <div
      ...
      style={{ background: 'linear-gradient(160deg, #080808 0%, #100808 40%, #0a0a0a 100%)' }}
    />
    <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="fade-up-element">
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="section-title text-2xl mb-3">Message Sent</h3>
                  <p className="text-soft-grey text-sm leading-relaxed max-w-xs">
                    We reply with a more personal and considered approach, based on your build and goals. You will hear from us shortly.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  {[
                    ...
                    { name: 'car', label: 'Car / Build', type: 'text', placeholder: 'e.g. Golf Mk2 GTI 16V' },
                  ].map((field) => (
                    <div key={field.name}>
                      <label
                        htmlFor={field.name}
                        className="block text-xs uppercase tracking-[0.15em] text-soft-grey mb-2 font-semibold"
                      >
                        {field.label}
                      </label>
                      <input
            ...
            <div className="fade-up-element" style={{ transitionDelay: '0.15s' }}>
              ...
              <h2 className="section-title text-2xl sm:text-3xl mb-5">
                A personal reply, not a template.
              </h2>
              <p className="text-soft-grey text-sm leading-relaxed mb-10">
                We reply with a more personal and considered approach, based on your build and goals. Every enquiry is read carefully — tell us what you're working with.
              </p>
              ...
              <div className="flex flex-col gap-4 mb-10">
                {[
                  {
                    icon: <Mail size={16} className="text-primary-red" />,
                    label: 'Email',
                    value: 'info@classicmotionperformance.com',
                    href: 'mailto:info@classicmotionperformance.com',
                  },
                  {
                    icon: <Phone size={16} className="text-primary-red" />,
                    label: 'Phone',
                    value: '+371 XXXXXXXX',
                    href: 'tel:+371XXXXXXXX',
                  },
                  {
                    icon: <span className="text-primary-red"><InstagramIcon /></span>,
                    label: 'Instagram',
                    value: '@classicmotionperformance',
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(15,6,6,0.9) 0%, rgba(20,10,10,0.95) 100%)',
                  border: '1px solid rgba(217,31,38,0.12)',
                }}
              >
                <div
                  className="absolute top-0 right-0 w-40 h-40 opacity-20 rounded-full"
                  style={{ background: 'radial-gradient(circle, rgba(217,31,38,0.5) 0%, transparent 70%)', transform: 'translate(30%, -30%)' }}
                />
                <p className="section-eyebrow mb-3">Response time</p>
                <p className="text-text-white font-display font-semibold text-sm mb-2">
                  Personal. Considered. Honest.
                </p>
                <p className="text-soft-grey/60 text-xs leading-relaxed">
                  We don't use automated responses. Every reply is tailored to your specific build and goals — because that's the only way to give useful advice.
                </p>
              </div>
            </div>
          </div>
